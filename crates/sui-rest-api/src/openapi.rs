...
use openapiv3::v3_1::{Operation, Parameter, RequestBody, Responses, SchemaObject};
...
pub trait ApiEndpoint<S> {
    ...
    fn register_schemas(&self, _generator: &mut SchemaGenerator) {}
...
use openapiv3::v3_1 as openapi;
use schemars::gen::SchemaGenerator;

impl<'a, S> Api<'a, S> {
    pub fn new(info: openapi::Info) -> Self {
        Self {
            endpoints: Vec::new(),
            info,
        }
