...
use super::{BodyHandler, ResponseHandler};
...
pin_project! {
    ...
    pub struct CallbackBody<B, BodyHandler> {
        #[pin]
        pub(crate) inner: B,
        pub(crate) handler: BodyHandler,
    }
}

impl<B, BodyHandlerT> Body for CallbackBody<B, BodyHandlerT>
where
    B: Body,
    B::Error: fmt::Display + 'static,
    BodyHandlerT: BodyHandler,
{
    type Data = B::Data;
    type Error = B::Error;
